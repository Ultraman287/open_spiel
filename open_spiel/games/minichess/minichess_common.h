...
#ifndef OPEN_SPIEL_GAMES_IMPL_COMMON_MINICHESS_COMMON_H_
#define OPEN_SPIEL_GAMES_IMPL_COMMON_MINICHESS_COMMON_H_
...
#endif // OPEN_SPIEL_GAMES_IMPL_COMMON_MINICHESS_COMMON_H_
